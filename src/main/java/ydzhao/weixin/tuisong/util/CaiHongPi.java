...
public class CaiHongPi {
    private static String key = "f540c5ae59ea640c519cb8043ee4c5df";
    ...
    public static String[] getJinJuString() {
        Random random = new Random();
        String mixed_sentence = jinJuList.get(random.nextInt(jinJuList.size()));
        String[] res = mixed_sentence.split("\n");
