...
public class JiNianRi {
     ...
     * 恋爱
     */
    static String lianAi = "2020-08-19";
    /**
     * 领证
     */
    static String linZheng = "2023-09-22";
    /**
     * 结婚
     */
    static String jieHun = "2023-09-22";
    /**
     * 生日
     */
    static String shengRi = "2023-08-06";
     ...
     * @return
     */
    public static int day_dif(String date) {
        int day = 0;
        try {
    ...
    public static int getJieHun() {
        return day_dif(jieHun);
    }

    public static int getLinZhen() {
        return day_dif(linZheng);
    }

    public static int getLianAi() {
        return day_dif(lianAi);
    }

    public static int getShengRi(){
        return day_dif(shengRi);
    }
